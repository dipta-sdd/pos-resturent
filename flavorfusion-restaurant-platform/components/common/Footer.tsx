      ...
      <div className="container max-w-full ">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-16 px-4 sm:px-6 lg:px-8 pb-4">
          ...
          <div className="lg:col-span-4">
             <Link to="/" className="flex items-center gap-2 text-3xl font-bold text-white mb-4 font-serif">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-4 space-y-3">
              <li><Link to="/" className="text-base text-gray-300 hover:text-orange-400">Home</Link></li>
              <li><Link to="/menu" className="text-base text-gray-300 hover:text-orange-400">Menu</Link></li>
              <li><Link to="/about" className="text-base text-gray-300 hover:text-orange-400">About Us</Link></li>
              <li><Link to="/contact" className="text-base text-gray-300 hover:text-orange-400">Contact</Link></li>
              <li><Link to="/reserve" className="text-base text-gray-300 hover:text-orange-400">Reservations</Link></li>
            </ul>
          </div>
