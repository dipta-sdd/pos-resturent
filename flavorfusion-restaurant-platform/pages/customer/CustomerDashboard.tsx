...
const QuickLinkCard = ({ to, title, description, icon: Icon }: { to: string; title: string; description: string; icon: React.ElementType }) => (
    <Link to={to} className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm hover:shadow-lg transition-shadow text-center flex flex-col items-center justify-start h-full border border-gray-200/50 dark:border-gray-700/50">
...
const CustomerDashboard: React.FC = () => {
    ...
    const breadcrumbs = [{ name: 'Dashboard', path: '/customer/dashboard' }];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden flex-grow border border-gray-200/80 dark:border-gray-700/60 flex flex-col">
                            {mockLatestOrder ? (
                                <>
                                    <img src={mockLatestOrder.imageUrl} alt="Latest order of spaghetti" className="w-full h-64 object-cover" />
                                    <div className="p-6 flex flex-col sm:flex-row justify-between sm:items-end gap-4">
                                        ...
                                        <Link to={`/customer/orders/${mockLatestOrder.id}`} className="bg-orange-500 text-white font-bold py-3 px-6 rounded-xl hover:bg-orange-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 whitespace-nowrap self-start sm:self-end">
                                            View Details
                                        </Link>
                                    </div>
                                </>
                                ...
                                <div className="flex flex-col items-center justify-center text-center p-8 h-full min-h-[300px]">
                                    ...
                                    <Link to="/menu" className="bg-orange-500 text-white font-bold py-3 px-6 rounded-xl hover:bg-orange-600 transition-colors">
                                        Browse Menu
                                    </Link>
                                </div>
                            )}
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden flex-grow border border-gray-200/80 dark:border-gray-700/60 flex flex-col">
                            {mockNextReservation ? (
                                <>
                                    <img src={mockNextReservation.imageUrl} alt="Restaurant interior for reservation" className="w-full h-64 object-cover" />
                                    <div className="p-6 flex flex-col sm:flex-row justify-between sm:items-end gap-4">
                                        <div className="flex-grow">
                                        ...
                                        <Link to={`/customer/reservations/${mockNextReservation.id}`} className="bg-orange-500 text-white font-bold py-3 px-6 rounded-xl hover:bg-orange-600 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 whitespace-nowrap self-start sm:self-end">
                                            Manage
                                        </Link>
                                    </div>
                                </>
                                ...
                                <div className="flex flex-col items-center justify-center text-center p-8 h-full min-h-[300px]">
                                    ...
                                    <Link to="/reserve" className="bg-orange-500 text-white font-bold py-3 px-6 rounded-xl hover:bg-orange-600 transition-colors">
                                        Book a Table
                                    </Link>
                                </div>
                            )}
