                ...
                <div className="col-span-2 md:col-span-1 flex items-center justify-end gap-3">
                    {isUpcoming ? (
                        <>
                         ...
                         <Link to="/reserve" className="bg-orange-500 text-white font-semibold py-2.5 px-6 rounded-lg hover:bg-orange-600 transition-colors">
                            Book Again
                        </Link>
                    )}
                </div>
...
const EmptyState: React.FC = () => (
    <div className="text-center py-20 bg-gray-50 dark:bg-gray-800/30 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-700">
        ...
        <div className="mt-6">
            <Link to="/reserve" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                Book a Table
            </Link>
        </div>
    </div>
