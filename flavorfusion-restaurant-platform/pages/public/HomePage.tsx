        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden group transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-5">
                ...
                <div className="mt-4 flex justify-between items-center">
                    <Link to={`/menu/${item.id}`} className="font-semibold text-orange-500 hover:text-orange-600 transition-colors">
                        View Details &rarr;
                    </Link>
                    <button 
            ...
            <section className="relative h-screen w-full overflow-hidden">
                ...
                <div className="relative h-full flex flex-col items-center justify-center text-center text-white z-10 p-4 pb-20 px-8 sm:px-16">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link to="/reserve" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-full text-lg transition-transform transform hover:scale-105 shadow-lg">
                            Book a Table
                        </Link>
                        <Link to="/menu" className="bg-transparent border-2 border-white text-white font-bold py-4 px-10 rounded-full text-lg transition-transform transform hover:scale-105 hover:bg-white hover:text-black">
                            Order Online
                        </Link>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition-shadow hover:shadow-xl">
                            ...
                            <Link to="/reserve" className="font-semibold text-red-600 hover:text-red-700 transition-colors">
                                Book Table →
                            </Link>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg transition-shadow hover:shadow-xl">
                            ...
                            <Link to="/menu" className="font-semibold text-red-600 hover:text-red-700 transition-colors">
                                Order Now →
                            </Link>
                        </div>
            ...
            <section className="py-24 bg-zinc-100 dark:bg-gray-900 relative">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mt-16">
                        <Link to="/menu" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-10 rounded-full text-lg transition-transform transform hover:scale-105 shadow-lg">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div>
                            <iframe
                                ...
                                // FIX: allowFullScreen prop must be a boolean. An empty string is invalid.
                                allowFullScreen
                                loading="lazy"
