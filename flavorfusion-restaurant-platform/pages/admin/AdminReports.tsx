        ...
        <div>
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-4">
                    <label htmlFor="date-range" className="text-gray-700 dark:text-white">Date Range:</label>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Profit & Loss</h2>
                    <ResponsiveContainer width="100%" height={300}>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Order Types</h2>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Expense Report</h2>
                    <ResponsiveContainer width="100%" height={300}>
                        <PieChart>
                ...
                <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">Top Selling Items</h2>
