      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white border-b pb-3 border-gray-200 dark:border-gray-700">Restaurant Information</h2>
          ...
          {/* Social Media Links */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white border-b pb-3 border-gray-200 dark:border-gray-700">Social Media Links</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div>
          ...
          {/* Financial Settings */}
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white border-b pb-3 border-gray-200 dark:border-gray-700">Financial Settings</h2>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white border-b pb-3 border-gray-200 dark:border-gray-700">Operational Settings</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              <div>
