...
const AdminMenuManagement: React.FC = () => {
  ...
  const handleAddNew = () => {
    if (activeTab === 'items') navigate('/dashboard/menu/new');
                        ...
                        {loadingItems ? (
                            ...
                            <tr key={item.id}>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <Link to={`/dashboard/menu/edit/${item.id}`} className="flex items-center group">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <button onClick={() => navigate(`/dashboard/menu/edit/${item.id}`)} className="text-orange-600 hover:text-orange-900 dark:text-orange-400 dark:hover:text-orange-300 mr-4"><Edit size={18} /></button>
