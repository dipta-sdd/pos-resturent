              ...
              <div>
                   ...
                   {activeDelivery ? (
                       <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
                            ...
                            <Link to={`/rider/delivery/${activeDelivery.id}`} className="mt-4 w-full block text-center bg-orange-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-orange-600">
                                View Details
                            </Link>
                       </div>
                   ) : (
